...
const addCompanyResolver = async (_, { name, foundedYear, country }) => {
...
const editCompanyResolver = async (_, { _id, name, foundedYear, country }) => {
    ...
    if (foundedYear !== undefined)
        recordCompany.foundedYear = foundedYear;
    if (country !== undefined)
        recordCompany.country = country;
...
const removeCompanyResolver = async (_, { _id }) => {
...
export { recordCompanyByIdResolver, companysResolver, companyByFoundedYearResolver, companyTypeResolver, editCompanyResolver, addCompanyResolver, removeCompanyResolver };
